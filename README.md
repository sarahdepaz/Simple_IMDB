...
```
Brad Pitt, Sleepers, Troy, Meet Joe Black, Ocean's Eleven, Seven, Mr & Mrs Smith
...
Julia Roberts, Pretty Woman, Ocean's Eleven, Runaway Bride
...
George Clooney, Ocean's Eleven, Intolerable Cruelty
...
```
new_movies.txt - the output database if the databse was modified.
